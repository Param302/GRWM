            ...
            <div className="w-full max-w-2xl">
                ...
                <div className="border-4 border-black bg-white p-4 sm:p-6 lg:p-8 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
                    ...
                    <input
                        ...
                        placeholder="octocat"
                        className="w-full px-4 sm:px-6 py-3 sm:py-4 text-xl sm:text-2xl font-mono border-4 border-black focus:outline-none focus:ring-0 bg-[#fff] text-black placeholder:text-black/30 transition-all"
                        autoFocus
                    />
